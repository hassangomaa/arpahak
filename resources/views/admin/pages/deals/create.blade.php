...
<main class="main" id="main">
            ...
            <div class="col-lg-12 col-md-6 d-flex flex-column align-items-center justify-content-center">
              <div class="card mb-3 w-100">
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" enctype="multipart/form-data" method="POST" action="{{route('store.trade')}}">
                    @csrf
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id" id="category_id">
                                    <option value=""> نوع التداول</option>
                                        ...
                                        <option value="2">عملية الشراء</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" readonly class="form-control" value="0" id="metal_price" name="net_price"  required >
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="form-group">
  ...
  <script>
    function price()
    {
        ...
        var url = "{{route('metal.price',['id' => 11111])}} ";
